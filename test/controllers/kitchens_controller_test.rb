...
class KitchensControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post kitchens_url, params: { kitchen: { description: @kitchen.description, name: @kitchen.name, restaurant_id: @kitchen.restaurant_id } }
  #   end
  #
  ...
  #   patch kitchen_url(@kitchen), params: { kitchen: { description: @kitchen.description, name: @kitchen.name, restaurant_id: @kitchen.restaurant_id } }
