...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post order_items_url, params: { order_item: { kitchen_id: @order_item.kitchen_id, quantity: @order_item.quantity, state: @order_item.state } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { kitchen_id: @order_item.kitchen_id, quantity: @order_item.quantity, state: @order_item.state } }
